...
You can read the [[http://docs.basho.com/riak/latest/community/bugs/][full guidelines for bug reporting and code contributions]] on the Riak Docs. 
...
** Testing
  ...
  download QuickCheck Mini: http://quviq.com/index.html NOTE: Some
